...
Original file is located at
    https://colab.research.google.com/drive/1Z72SnMjQY7_xF_8vs64z02qSWfyZ-A88

Name: Sharwari Ambade
...
st.sidebar.markdown('<p class="font">Filter App</p>', unsafe_allow_html=True)
